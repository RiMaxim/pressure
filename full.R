...
df_main <- subset(df0, variable %in% c("Systolic", "Diastolic", "Pulse"), select = c(Day,value,variable,Type))
...
# 1. Загрузить основной файл
df0 <- read.table("Desktop/presser/data.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
df_main <- subset(df0, variable %in% c("PP"), select = c(Day,value,variable,Type))
...
# 1. Загрузить основной файл
df0 <- read.table("Desktop/presser/data.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
df_main <- subset(df0, variable %in% c("MAP"), select = c(Day,value,variable,Type))
...
# 1. Загрузить основной файл
df0 <- read.table("Desktop/presser/data.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
df_main <- subset(df0, variable %in% c("RPP"), select = c(Day,value,variable,Type))
...
# 1. Загрузить основной файл
df0 <- read.table("Desktop/presser/data.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
df_main <- subset(df0, variable %in% c("TI"), select = c(Day,value,variable,Type))
...
pdf_combine(input = pdf_files, output = "Desktop/presser/Report.pdf")
